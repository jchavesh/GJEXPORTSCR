        ...
        <div className="grid gap-12 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-primary" /> <a href="mailto:info@jgexportscr.com" className="hover:text-primary">info@jgexportscr.com</a>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-primary" /> <a href="tel:+50661330225" className="hover:text-primary">+506 6133 0225</a>
              </div>
            </div>
            <a href="https://wa.me/50661330225" target="_blank" rel="noopener noreferrer" className="inline-block">
